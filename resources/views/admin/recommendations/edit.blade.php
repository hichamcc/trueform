...
@section('page-title', 'Edit Product Recommendation')
@section('page-subtitle', 'Update recommendation details')
        ...
        <form action="{{ route('admin.recommendations.update', $recommendation) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="kpi" required
                    ...
                    <option value="energy" {{ $recommendation->kpi === 'energy' ? 'selected' : '' }}>Energy</option>
            ...
            <div>
                ...
                <input type="text" name="product_name" required maxlength="255"
                       value="{{ old('product_name', $recommendation->product_name) }}"
                       class="w-full px-4 py-3 bg-[#0f0f0f] border border-silver-900/30 rounded-lg text-silver-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
            ...
            <div>
                ...
                <input type="url" name="product_link" maxlength="500"
                       value="{{ old('product_link', $recommendation->product_link) }}"
                       class="w-full px-4 py-3 bg-[#0f0f0f] border border-silver-900/30 rounded-lg text-silver-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
            ...
            <div>
                ...
                <textarea name="description" rows="4" maxlength="1000"
                          class="w-full px-4 py-3 bg-[#0f0f0f] border border-silver-900/30 rounded-lg text-silver-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
                          placeholder="Brief description of the product and how it helps...">{{ old('description', $recommendation->description) }}</textarea>
